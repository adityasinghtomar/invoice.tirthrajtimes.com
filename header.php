...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>Ti-</b>Rj</span>
       <!--logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Tirth Raj</b>Times</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Menu 2 -->
         <li class="treeview">
          <a href="#"><i class="fa fa-shopping-basket"></i><span>Rate</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="product-add.php"><i class="fa fa-plus"></i>Add Rate</a></li>
            <li><a href="product-list.php"><i class="fa fa-cog"></i>Manage Rates</a></li>
          </ul>
        </li>
        <!-- Menu 3 -->
        <li class="treeview">
